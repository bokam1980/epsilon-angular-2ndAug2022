...
import { AUTH_URL, AUTH_URL_VALUE, PRODUCT_SERVICE, PRODUCT_URL, PRODUCT_URL_VALUE, PRODUCT_SERVICE_CLASS_NAME } from '../../utils/appconstants';
  ...
  providers: [
    {
      ...
      useClass: PRODUCT_SERVICE_CLASS_NAME
    },
    {
      provide: PRODUCT_URL,
